...
class ProcessTable:
    ...
    def display_table(self):
        print("{:<5} {:<10} {:<20} {:<8}".format("P_ID", "Process", "Start Time (ms)", "Priority"))
        print("="*45)
        for process in self.processes:
            print("{:<5} {:<10} {:<20} {:<8}".format(process.p_id, process.process_name, process.start_time, process.priority))

def main():
    process_table = ProcessTable()
    
    # Adding processes to the table
